...
class StructureActive(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            df.loc[df.area.notnull() & (df.area != 'a province'), 'area'] = 'out of province'
            df.loc[df.area == 'a province', 'area'] = 'in the province'
            df.loc[df.nation.notnull() & (df.nation != 'a nation'), 'nation'] = 'minor nation'
...
class StructureAllTime(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            df.loc[df.area_simple.notnull() & (df.area_simple != 'a province'), 'area_simple'] = 'out of province'
            df.loc[df.area_simple == 'a province', 'area_simple'] = 'in the province'
            df['nation_simple'] = df['nation']
            df.loc[df.nation_simple.notnull() & (df.nation_simple != 'a nation'), 'nation_simple'] = 'minor nation'
